...
//			break;
		case 0: ofDrawBitmapString("drawing mode: clockwise", 50, 90);
			break;
		case 1: ofDrawBitmapString("drawing mode: counter-clockwise", 50, 90); 
			break;
	}	
}
...
//			case 1: VF.addOutwardCircle((float)x, (float)y, 100, 0.3f);
				break;
			case 0: VF.addClockwiseCircle((float)x, (float)y, 100, 0.3f);
				break;
			case 1: VF.addCounterClockwiseCircle((float)x, (float)y, 100, 0.3f);
				break;
		}		
	} else {
